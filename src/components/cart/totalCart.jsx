  ...
  return (
    <div className={styles.total}>
      ...
      <div className={styles.pay_minus}>
        <img src="/images/icons/icon-minus-line.svg" alt="minus" />
      </div>
